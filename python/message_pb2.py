...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    b'\n\rmessage.proto\x12\x03p2p"\xa6\x01\n\x07Message\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04type\x18\x02 \x01(\t\x12\x0f\n\x07payload\x18\x03 \x01(\x0c\x12\x11\n\ttimestamp\x18\x04 \x01(\x03\x12,\n\x08metadata\x18\x05 \x03(\x0b\x32\x1a.p2p.Message.MetadataEntry\x1a/\n\rMetadataEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t:\x02\x38\x01\x62\x06proto3'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_MESSAGE_METADATAENTRY"]._serialized_start = 142
    _globals["_MESSAGE_METADATAENTRY"]._serialized_end = 189
